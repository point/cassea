...
"<script type=\"text/javascript\">$(\"#",$p->id,"\").datepicker({ dateFormat: '",$p->date_format,"',showOn: 'both', buttonImageOnly: true, buttonImage:'/w_images/calendar.gif',yearRange: '-80:+30'});</script>";
?>
